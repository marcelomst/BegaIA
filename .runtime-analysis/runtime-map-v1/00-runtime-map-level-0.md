...
Es una vista navegable para entender:
...
Su interior se explota recién en el Nivel 1.
...
flowchart TD
    ...
    B --> B2["WhatsApp"]
    B --> B3["Email"]
    B --> B4["Channel // Path: .runtime-analysis/runtime-map-v1/00-runtime-map-level-0.md
...
Eso representa la salida externa del runtime hacia el canal.
...
Eso representa una etapa interna de `messageHandler.ts`, donde se actualiza estado y se compone la respuesta observable.
...
- El graph existe como componente de interpretación/routing, pero no reemplaza al runtime principal.
...
- Sirve para comprensión, documentación personal, análisis de fronteras y futura coordinación con agentes.
