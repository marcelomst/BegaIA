 ...
 */
export const RE_TRANSPORT = /(aeroporto|aeropuerto|airport|traslados?|transfer|transport(?:e|ation)?|shuttle|t[aá]xi|remis|bus|[ôo]nibus|omnibus|colectivo|metro|subte)/i;
