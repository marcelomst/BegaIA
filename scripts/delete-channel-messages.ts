// Path: /scripts/delete-channel-messages.ts
//  pnpm exec tsx scripts/delete-channel-messages.ts
...
async function main() {
  ...
  const conversationFilter: any = { channel: channelId  };
  ...
  console.log(`✔️ Listo. Eliminados:\n - ${deletedMessages} mensajes de ${channelId}\n - ${deletedConversations} conversaciones de ${channelId}${HOTEL_ID ? " para " + HOTEL_ID : ""}.`);
}
